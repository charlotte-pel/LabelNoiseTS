...
def initParamValues(option, nb_params=26, nb_class_panel=14):
    ...
    if option == 1:
        ...
        # 140.0000   10.0000
        param_val[:, 6] = [0.73, 0.78, 0.1, 0.15, 35, 40, 18, 22, 83, 87, 3, 7, 500, 20, 0.62, 0.67, 0.07, 0.13, 88, 92,
                           3, 7, 137, 143, 7, 13]
        # Barley
        param_val[:14, 7] = [0.57, 0.62, 0.25, 0.3, 50, 70, 10, 15, 140, 150, 10, 15, 500, 20]
        # Bi-culture: wheat-soy
        param_val[:, 8] = [0.5, 0.55, 0.10, 0.15, 45, 55, 10, 15, 130, 135, 2, 5, 500, 20, 0.65, 0.7, 0.10, 0.15, 170,
        ...
        # Rapeseed 0.5500    0.1000   40.0000   20.0000   85.0000    5.0000    0.4500    0.1000   90.0000    5.0000
        # 140.0000   10.0000
        param_val[:, 6] = [0.70, 0.8, 0.05, 0.20, 30, 45, 15, 25, 80, 90, 3, 12, 500, 10, 0.60, 0.70, 0.05, 0.15, 85,
                           95, 3, 12, 135, 145, 5, 15]
        # Barley
        param_val[:14, 7] = [0.52, 0.67, 0.20, 0.35, 30, 90, 5, 25, 120, 170, 5, 25, 500, 10]
        # Bi-culture: wheat-soy
        param_val[:, 8] = [0.5, 0.55, 0.10, 0.15, 45, 55, 10, 15, 130, 135, 2, 5, 500, 10, 0.65, 0.7, 0.10, 0.15, 170,
                           180, 10, 15, 280, 300, 25, 35]
        # Evergreen
    ...
    return np.transpose(param_val), class_names
